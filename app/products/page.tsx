      ...
      <section className="bg-green-900 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-green-100">Explore our premium collection of reliable powerbanks for every need</p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8 space-y-4">
            ...
            <p className="text-sm text-gray-600">
              Showing {isLoading ? 0 : filteredProducts.length} of {PRODUCTS.length} products
            </p>
          </div>
            ...
            {isLoading
              ...
              : // Show no results message
                <div className="col-span-full text-center py-12">
                  <p className="text-gray-600 text-lg">No powerbanks found matching your criteria</p>
                </div>
            }
          </div>
        </div>
